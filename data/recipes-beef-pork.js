...

{
  ...
  blurb: "The Sunday dinner. Three hours in the oven and the house smells like someone loves you.",
  ...
  steps: [
    ...
    "Heat the oil in a Dutch oven over medium-high. Sear the roast 4 to 5 minutes per side until a deep brown crust forms on every surface. Do not rush this; it is where most of the flavor comes from. Move to a plate.",
  ...
  tips: [
    ...
    "If the meat is tough it needs more time, not less. Tough means the collagen has not broken down yet."
  ],
...

{
  ...
  steps: [
    ...
    "Heat the oil in a heavy skillet over high until it just starts to smoke. Lay the steaks in and do not touch them for 4 minutes.",
...

{
  ...
  steps: [
    ...
    "Soak the panko in the milk for 5 minutes until it is a soft paste.",
...

{
  ...
  steps: [
    "Toss the sliced beef with the cornstarch, soy sauce, and baking soda. Let it sit 15 minutes - the baking soda is a restaurant trick that keeps cheap beef genuinely tender.",
  ...
  tips: [
    "Slice the flank steak across the grain, and slice it while it is partly frozen if you want really thin pieces.",
    "Do not skip rinsing off the baking soda or the dish tastes faintly soapy."
  ],
  makeAhead: null
},

{
  id: "cottage-pie",
  title: "Cottage Pie",
  blurb: "Savory beef and vegetables under a browned crust of mashed potato. Total comfort in one dish.",
  ...
  steps: [
    ...
    "Heat the oven to 400F. Spread the filling in a 9x13 dish and spoon the mash over it, starting at the edges so the filling cannot bubble up the sides. Rough up the surface with a fork and scatter the remaining cheddar over.",
...

{
  ...
  tips: [
    ...
    "Use a firm apple - Honeycrisp, Braeburn, Granny Smith. Softer varieties turn to sauce."
  ],
  makeAhead: null
},
...

{
  ...
  tips: [
    "The crisping step is the whole difference between carnitas and plain pulled pork. Do not skip it.",
...

{
  ...
  makeAhead: "The beef reheats perfectly, so it is excellent for lunches."
},
...

{
  ...
  steps: [
    ...
    "Divide the beef into 8 loose balls. Do not compact them - handle the meat as little as possible.",
  ...
  tips: [
    "Smash within the first 10 seconds of the patty hitting the pan. After that the crust has set and it will not spread.",
    "Scrape rather than lift when flipping - all the browned crust is stuck to the pan and that is the best part."
  ],
  makeAhead: null
},
...

{
  ...
  blurb: "The big one. Three hours of quiet oven time for meat that gives way at the touch of a fork.",
  ...
  steps: [
    ...
    "Heat the oil in a large Dutch oven over medium-high. Sear the ribs in batches, 3 minutes per side, until every surface is deeply browned. This takes about 20 minutes and is not the place to hurry. Move to a plate.",
  ...
  makeAhead: "Genuinely better made one to two days ahead. Reheat covered at 325F for 40 minutes."
},

{
  ...
  tips: [
    ...
    "Toasting the buns is not optional unless you enjoy the sandwich falling apart."
  ],
...

{
  ...
  steps: [
    ...
    "Put each pork slice between plastic and pound to 1/4 inch - genuinely thin. Season both sides.",
...

{
  ...
  tips: [
    ...
    "Do not marinate longer than a few hours - the lime juice starts to cure the surface and turns it grey."
  ],
...

{
  ...
  steps: [
    ...
    "Melt the butter in a large skillet over medium. Brown the meatballs in batches, rolling them around, about 6 minutes each batch. They do not need to be cooked through yet. Move to a plate.",
  ...
  tips: [
    "The nutmeg and allspice are what make these Swedish rather than Italian. Do not leave them out.",
...

{
  ...
  steps: [
    ...
    "Heat 1 tablespoon oil in a large skillet or wok over high. Add the green beans and cook 6 to 8 minutes, stirring only every couple of minutes, until they are blistered and wrinkled in spots. Move to a plate.",
...

{
  ...
  blurb: "Fast, elegant, and genuinely special: a hard sear and a bright green herb topping.",
...

{
  ...
  blurb: "Sweet-sour cabbage that cooks itself while the chops sear. It looks like a restaurant plate.",
  emoji: "🥬", protein: "Pork", cuisine: "German",
  ...
  tips: [
    ...
    "Caraway is the flavor you recognize but cannot name in good red cabbage. Worth buying a jar."
  ],
...

{
  ...
  tips: [
    "Dice the potato small, about 1/4 inch, or it will not cook through in time.",
...

{
  ...
  steps: [
    ...
    "Add the butter, onions, and sugar to the same pan with a pinch of salt. Cook 18 to 20 minutes over medium-low, stirring often, until deep golden and jammy. This is the whole dish - do not rush it.",
...

{
  ...
  steps: [
    ...
    "If the bacon is not crisp, run it under the broiler for 3 minutes, watching closely.",
