...

{
  ...
  blurb: "A proper meat sauce with milk and wine, simmered until it goes glossy and deep. Worth the afternoon.",
  ...
  steps: [
    "Heat the oil and butter in a heavy pot over medium. Cook the onion, carrot, and celery slowly for 12 to 15 minutes, until completely soft and sweet. This base is the foundation - do not rush it.",
  ...
  tips: [
    "The milk step sounds strange and is what separates real bolognese from a tomato meat sauce. Do not skip it.",
    "Always toss the pasta in the sauce rather than ladling sauce on top. It is the difference between coated pasta and pasta with a puddle."
  ],
...

{
  ...
  tips: [
    "Undercooking the pasta by two minutes is the single most important step. It will not be undercooked when it comes out.",
...

{
  ...
  steps: [
    ...
    "Rest at least 30 minutes before cutting. This is not optional if you want slices instead of landslides."
  ],
  tips: [
...

{
  ...
  plate: { protein: "Parmesan and peas", starch: "Penne", veg: "Asparagus, zucchini, peas, tomato" },
  nutrition: { calories: 545, protein: 20, carbs: 74, fat: 19, fiber: 8 },
  ...
  steps: [
    ...
    "Add the tomatoes and peas and cook 3 minutes, just until the tomatoes begin to slump.",
...

{
  ...
  blurb: "Pasta cooked right in the sauce, so there is one pot and no colander. Twenty-five minutes, start to finish.",
  emoji: "🍅", protein: "Vegetarian", cuisine: "Italian",
  totalTime: 25, activeTime: 20, difficulty: "Easy", servings: 4,
  plate: { protein: "Cheese and cream", starch: "Penne", veg: "Tomato and spinach" },
  nutrition: { calories: 555, protein: 19, carbs: 78, fat: 19, fiber: 7 },
  ...
  steps: [
    ...
    "Take the pot off the heat and stir in the cream and Parmesan. Finish with basil."
  ],
  tips: [
...

{
  ...
  blurb: "Twenty minutes of stirring for something genuinely luxurious. Put on music and enjoy it.",
  emoji: "🍚", protein: "Vegetarian", cuisine: "Italian",
  totalTime: 50, activeTime: 45, difficulty: "Medium", servings: 4,
  plate: { protein: "Parmesan", starch: "Arborio rice", veg: "Mushrooms" },
  nutrition: { calories: 545, protein: 17, carbs: 72, fat: 20, fiber: 4 },
...

{
  ...
  plate: { protein: "Pine nuts and Parmesan", starch: "Trofie and potatoes", veg: "Green beans and basil" },
  nutrition: { calories: 665, protein: 20, carbs: 78, fat: 31, fiber: 7 },
  ...
  steps: [
    ...
    "Blend the basil, pine nuts, garlic, Parmesan, and salt, drizzling in the olive oil, until it is a coarse green sauce. Do not over-blend it into a smooth paste.",
    ...
    "Return it all to the warm pot off the heat. Add the butter, the pesto, and half a cup of pasta water.",
    "Toss thoroughly, adding more water until it is glossy and coats everything. Never heat pesto directly - it turns bitter and dull."
  ],
  tips: [
...

{
  ...
  steps: [
    "Boil the shells 2 minutes less than the package says. Drain and spread them on a sheet pan so they do not stick together.",
...

{
  ...
  blurb: "Crisped gnocchi, sweet roasted squash, and nutty brown butter. Autumn on a plate in half an hour.",
  emoji: "🎃", protein: "Vegetarian", cuisine: "Italian",
  totalTime: 40, activeTime: 25, difficulty: "Easy", servings: 4,
  plate: { protein: "Parmesan and walnuts", starch: "Gnocchi", veg: "Butternut squash and kale" },
  nutrition: { calories: 585, protein: 17, carbs: 68, fat: 28, fiber: 7 },
  ...
  steps: [
    "Heat the oven to 425F. Toss the squash with 2 tablespoons oil and half the salt and roast 25 minutes, until tender and browned.",
  ...
  tips: [
    "Pan-frying shelf-stable gnocchi without boiling gives you a crisp shell and a chewy middle. It is far better than the boiled version.",
    "Brown butter goes from nutty to burnt in about thirty seconds. Watch the color and pull it early."
  ],
...

{
  ...
  steps: [
    ...
    "Add about 1/2 cup of the hot pasta water to the egg mixture in a thin stream while whisking hard. This warms the eggs gradually so they do not scramble.",
    ...
    "Loosen with more pasta water until it is glossy and flows. Serve immediately with more Pecorino and pepper."
  ],
  tips: [
    ...
    "There is no cream in carbonara. The silkiness comes from egg, cheese, fat, and starchy water, properly emulsified."
  ],
  makeAhead: null
},

{
  ...
  steps: [
    ...
    "Whisk in warm water a tablespoon at a time until it is the consistency of heavy cream and pours easily.",
...

{
  ...
  steps: [
    "Soak the rice noodles in hot tap water 25 to 30 minutes, until pliable but still firm. Do not boil them - they finish cooking in the pan.",
    ...
    "Have absolutely everything chopped and beside the stove. Pad Thai cooks in five minutes and there is no time to prep mid-cook.",
...

{
  ...
  plate: { protein: "Feta", starch: "Pasta", veg: "Cherry tomatoes and spinach" },
  nutrition: { calories: 585, protein: 22, carbs: 76, fat: 22, fiber: 6 },
  ...
  steps: [
    ...
    "Put the tomatoes and garlic in a baking dish, set the block of feta in the middle, and pour the olive oil over everything.",
  ...
  tips: [
    "Use a block of feta in brine, not the pre-crumbled kind. Crumbled feta is drier and will not go creamy.",
...

{
  ...
  nutrition: { calories: 505, protein: 18, carbs: 66, fat: 20, fiber: 12 },
  ...
  steps: [
    ...
    "Toss the warm farro with half the dressing - warm grains soak it up far better than cold ones.",
  ...
  makeAhead: "Keeps four days and is genuinely good cold for lunch."
},

{
  ...
  nutrition: { calories: 505, protein: 18, carbs: 72, fat: 17, fiber: 13 },
  ...
  tips: [
    ...
    "Couscous is not a grain that needs boiling - just hot liquid and ten minutes under a lid."
  ],
...

{
  ...
  nutrition: { calories: 525, protein: 22, carbs: 68, fat: 19, fiber: 6 },
  ...
  steps: [
    ...
    "Loosen with more pasta water until it is glossy and coats each strand. Fold in the broccoli and serve immediately."
  ],
  tips: [
