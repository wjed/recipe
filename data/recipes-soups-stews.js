...

{
  ...
  blurb: "Beef braised until it falls apart, with potatoes and carrots in a thick gravy.",
...

{
  ...
  blurb: "Made with bone-in chicken, so the broth tastes like chicken instead of water.",
...

{
  id: "minestrone",
  title: "Minestrone",
  blurb: "Beans, pasta, and whatever vegetables need using up.",
  ...
  tips: [
    "Save Parmesan rinds in the freezer. Dropped into any soup they add a savory depth you can't get another way.",
...

{
  ...
  blurb: "A starter, not a dinner. Velvety and faintly sweet, made deeper by roasting the squash instead of boiling it.",
  emoji: "🎃", protein: "Vegetarian", cuisine: "American",
  type: "side", sideType: "starter",
  ...
  tips: [
    "Roasting rather than boiling the squash is the difference. Boiled squash soup tastes watery and flat.",
...

{
  ...
  blurb: "Roasted tomato soup and a crisp, buttery cheese sandwich.",
  emoji: "🥪", protein: "Vegetarian", cuisine: "American",
  totalTime: 55, activeTime: 30, difficulty: "Easy", servings: 4,
  plate: { protein: "Cheddar", starch: "Bread", veg: "Tomatoes" },
  nutrition: { calories: 735, protein: 32, carbs: 53, fat: 45, fiber: 6 },
...

{
  ...
  steps: [
    ...
    "The soup is ready when the peas have completely collapsed and it's thick enough to hold a spoon upright for a moment.",
    ...
    "If it's thicker than you like, thin with hot broth."
  ],
  tips: [
    "Split peas don't need soaking. They break down on their own in about 90 minutes.",
...

{
  id: "beef-chili",
  title: "Beef Chili",
  blurb: "Thick, dark, and spiced, with a long enough simmer that everything melts together.",
...

{
  ...
  nutrition: { calories: 510, protein: 32, carbs: 39, fat: 26, fiber: 3 },
  ...
  steps: [
    ...
    "Stir in the cream and the clams and warm through gently for 5 minutes. Don't let it boil after the clams go in. They turn rubbery within a minute.",
...

{
  ...
  steps: [
    ...
    "Add the beans, then blend about a third of the soup and stir it back in. The beans disappear into it and make it thicker and much more filling.",
...

{
  ...
  blurb: "Tiny meatballs, little pasta, and greens in a clear, savory broth. Light but filling.",
  ...
  steps: [
    ...
    "Drop the meatballs in and simmer 12 minutes, until cooked through. Don't stir hard or they break apart.",
...

{
  ...
  steps: [
    ...
    "Serve with crusty bread, a drizzle of olive oil, and a spoonful of yogurt in each bowl."
  ],
  tips: [
    "Don't salt lentils heavily at the very start of cooking; they can stay firm. Season at the end.",
...

{
  ...
  steps: [
    "Start the rice.",
    "Bring the broth, lemongrass, galangal, and lime leaves to a simmer in a pot. Simmer 10 minutes to infuse, then fish out the aromatics if you like. They're for flavor, not eating.",
    "Add the coconut milk and bring back to a gentle simmer. Don't boil hard, or the coconut milk splits.",
...

{
  ...
  nutrition: { calories: 665, protein: 33, carbs: 49, fat: 38, fiber: 5 },
  ...
  steps: [
    ...
    "Cook, stirring every five minutes, for 45 to 60 minutes. They will go from pale to soft to golden to deep amber. There's no shortcut here. High heat burns them without developing the sweetness.",
  ...
  tips: [
    ...
    "Toast the bread dry. Soft bread dissolves into the soup instantly."
  ],
...

{
  ...
  blurb: "Fluffy dumplings steamed on top of a creamy chicken stew.",
  emoji: "🥟", protein: "Chicken", cuisine: "American",
  ...
  steps: [
    ...
    "For the dumplings, whisk the flour, baking powder, and salt. Rub in the cold butter with your fingertips until it looks like coarse crumbs. Stir in the milk and chives just until a shaggy dough forms. Don't overwork it.",
  ...
  tips: [
    "Don't lift the lid. Trapped steam is what makes the dumplings light instead of dense.",
...

{
  ...
  steps: [
    ...
    "Add the tomatoes, broth, squash, chickpeas, red lentils, and apricots with the salt. The lentils melt down and thicken the stew.",
...

{
  ...
  blurb: "A starter, not a dinner. Four ingredients and half an hour for a smooth, silky soup.",
  emoji: "🥔", protein: "Vegetarian", cuisine: "French",
  type: "side", sideType: "starter",
  ...
  steps: [
    "Slice the leeks and put them in a bowl of cold water. Swish them around and lift them out, leaving the grit behind. Leeks are always sandy and rinsing them under a tap doesn't get it all.",
  ...
  tips: [
    "Use a blender rather than a food processor, and don't over-blend. Overworked potato turns gluey.",
