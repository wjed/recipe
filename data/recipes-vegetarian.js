...

{
  ...
  plate: { protein: "Chickpeas", starch: "Basmati rice", veg: "Tomato and onion" },
  nutrition: { calories: 465, protein: 17, carbs: 72, fat: 13, fiber: 14 },
  ...
  steps: [
    "Heat the oil in a large pot over medium. Cook the onion 10 minutes, stirring often, until genuinely golden brown at the edges. Do not rush this - it is where the sweetness comes from.",
    ...
    "Serve over basmati rice with naan and the rest of the cilantro."
  ],
  tips: [
    "Whole spices are lovely but ground ones work fine as long as you toast them properly in the oil.",
    "A spoonful of yogurt on top cools it down for anyone who finds it too warm."
  ],
  makeAhead: "Genuinely better on day two and freezes for three months."
},

{
  ...
  nutrition: { calories: 520, protein: 20, carbs: 68, fat: 20, fiber: 13 },
...

{
  ...
  plate: { protein: "Beans", starch: "Corn and rice", veg: "Peppers, onions, tomato" },
  nutrition: { calories: 395, protein: 19, carbs: 66, fat: 8, fiber: 18 },
  ...
  steps: [
    ...
    "Add the crushed tomatoes, all three cans of beans, the corn, broth, cocoa powder, and salt.",
  ...
  tips: [
    "The cocoa powder does not make it taste like chocolate. It adds a dark background note that makes the chili taste like it simmered all day.",
...

{
  ...
  nutrition: { calories: 445, protein: 22, carbs: 38, fat: 24, fiber: 8 },
  ...
  tips: [
    ...
    "Do not drown the layers in sauce. A thin coat between layers keeps the crust from dissolving."
  ],
...

{
  ...
  nutrition: { calories: 445, protein: 17, carbs: 62, fat: 15, fiber: 13 },
  ...
  tips: [
    "Mushrooms and soy sauce are doing the savory work here. Do not leave either out.",
...

{
  ...
  blurb: "Tofu with a genuinely crisp crust, tossed with vegetables in a garlic-ginger sauce.",
  emoji: "🥢", protein: "Vegetarian", cuisine: "Chinese",
  totalTime: 40, activeTime: 30, difficulty: "Medium", servings: 4,
  plate: { protein: "Tofu", starch: "Rice", veg: "Broccoli and peppers" },
  nutrition: { calories: 470, protein: 22, carbs: 56, fat: 18, fiber: 6 },
  ...
  steps: [
    ...
    "Add the remaining oil, then the broccoli and peppers with 1/4 cup water. Cover and cook 3 minutes, then uncover and cook 3 minutes more.",
...

{
  ...
  plate: { protein: "Falafel", starch: "Pita and rice", veg: "Cucumber, tomato, greens" },
  nutrition: { calories: 555, protein: 20, carbs: 68, fat: 24, fiber: 15 },
  ...
  steps: [
    "Drain the soaked chickpeas thoroughly. Do not use canned chickpeas - they are too wet and the falafel will fall apart.",
    "Pulse the chickpeas, onion, garlic, herbs, spices, salt, and flour in a food processor until it looks like coarse wet sand that holds together when squeezed. Do not puree it smooth.",
    ...
    "Whisk the tahini with the lemon and garlic - it will seize - then loosen with cold water until pourable.",
    "Build bowls with rice, hummus, salad vegetables, falafel, pickles, and plenty of tahini sauce."
  ],
  tips: [
    "Dried soaked chickpeas are non-negotiable. This is the one recipe where the canned shortcut genuinely does not work.",
...

{
  ...
  nutrition: { calories: 385, protein: 17, carbs: 48, fat: 15, fiber: 10 },
...

{
  ...
  nutrition: { calories: 375, protein: 20, carbs: 32, fat: 20, fiber: 6 },
  ...
  steps: [
    ...
    "Taste and adjust the salt now - you cannot easily season it once the eggs are in.",
    "Make six wells in the sauce with the back of a spoon and crack an egg into each.",
  ...
  tips: [
    ...
    "Breakfast, lunch, or dinner. It is one of the best cheap dinners there is."
  ],
...

{
  ...
  plate: { protein: "Eggs and goat cheese", starch: "Potato", veg: "Spinach, tomato, onion" },
  nutrition: { calories: 315, protein: 20, carbs: 16, fat: 20, fiber: 3 },
  ...
  steps: [
    ...
    "Whisk the eggs, milk, salt, and pepper until completely uniform - no streaks of white.",
  ...
  tips: [
    ...
    "Any leftover cooked vegetables work here. It is a genuinely good way to clear out the fridge."
  ],
...

{
  ...
  blurb: "Veggie burgers that hold together and actually taste like something, with a smoky chipotle mayo.",
  emoji: "🍔", protein: "Vegetarian", cuisine: "American",
  totalTime: 45, activeTime: 30, difficulty: "Medium", servings: 4,
  plate: { protein: "Black beans", starch: "Buns", veg: "Lettuce, tomato, onion" },
  nutrition: { calories: 480, protein: 18, carbs: 62, fat: 18, fiber: 13 },
  ...
  steps: [
    "Heat the oven to 350F. Spread the drained beans on a sheet pan and bake 15 minutes to dry them out. This is the single most important step - wet beans make mushy burgers.",
    ...
    "Heat the oil in a skillet over medium. Cook the patties 5 minutes per side, turning once carefully, until a firm crust forms.",
...

{
  ...
  plate: { protein: "White beans", starch: null, veg: "Cauliflower" },
  nutrition: { calories: 385, protein: 14, carbs: 32, fat: 24, fiber: 12 },
  ...
  steps: [
    ...
    "Trim the leaves from each cauliflower but leave the core intact - it is what holds the steaks together. Stand each head upright and cut two 1-inch thick slabs from the center. Save the loose florets and roast them alongside.",
    ...
    "Spoon the warm white beans onto plates, set a cauliflower steak on top, and spoon chimichurri generously over.",
  ...
  tips: [
    ...
    "The cauliflower needs to be genuinely browned, not pale. Pale roasted cauliflower tastes like nothing."
  ],
...

{
  ...
  plate: { protein: "Paneer", starch: "Basmati rice", veg: "Spinach" },
  nutrition: { calories: 445, protein: 22, carbs: 42, fat: 22, fiber: 6 },
  ...
  steps: [
    ...
    "Add the cream, lemon juice, and paneer. Warm through 3 minutes and serve with rice and naan."
  ],
  tips: [
...

{
  ...
  plate: { protein: "Black beans", starch: "Corn tortillas", veg: "Cauliflower and cabbage" },
  nutrition: { calories: 420, protein: 15, carbs: 56, fat: 17, fiber: 14 },
...

{
  ...
  nutrition: { calories: 425, protein: 19, carbs: 68, fat: 9, fiber: 13 },
  ...
  tips: [
    ...
    "The tempering step looks fussy and is the entire flavor of the dish. Do not stir the spices straight into the pot."
  ],
...

{
  ...
  tips: [
    "Halloumi does not melt, it browns. Add it near the end so it stays firm rather than drying out.",
...

{
  ...
  emoji: "🍠", protein: "Vegetarian", cuisine: "Mexican",
  totalTime: 45, activeTime: 20, difficulty: "Easy", servings: 4,
  plate: { protein: "Black beans", starch: "Cilantro-lime rice", veg: "Sweet potato and peppers" },
  nutrition: { calories: 550, protein: 17, carbs: 88, fat: 16, fiber: 16 },
  ...
  steps: [
    ...
    "Cook the rice. When it is done, fork through the cilantro and lime juice.",
    "Warm the black beans in a small pot with the cumin, garlic, salt, and a splash of water, mashing a few against the side.",
    "Build the bowls: cilantro-lime rice, black beans, roasted vegetables, avocado, pico de gallo, and jalapenos.",
...

{
  ...
  plate: { protein: "Mushrooms", starch: "Egg noodles", veg: "Mushrooms and onion" },
  nutrition: { calories: 520, protein: 17, carbs: 62, fat: 24, fiber: 5 },
  ...
  steps: [
    ...
    "Return the mushrooms to the sauce and warm through.",
    "Take the pan off the heat. Whisk a ladle of hot sauce into the sour cream, then stir that back into the pan so it does not curdle.",
...

{
  ...
  blurb: "A custardy, deeply savory tart that is dinner with a salad and breakfast the next morning.",
  ...
  nutrition: { calories: 425, protein: 18, carbs: 24, fat: 29, fiber: 2 },
  ...
  tips: [
    ...
    "Squeeze the vegetables genuinely dry. This is the most common quiche failure."
  ],
...

{
  ...
  nutrition: { calories: 445, protein: 21, carbs: 46, fat: 21, fiber: 11 },
  ...
  ingredients: [
    ...
    { group: "To serve", items: [
      "8 corn tortillas",
      "3 tablespoons neutral oil",
      "1 (15 oz) can refried or black beans, warmed",
      "8 eggs",
...

{
  ...
  nutrition: { calories: 465, protein: 21, carbs: 52, fat: 20, fiber: 14 },
...

{
  ...
  plate: { protein: "Tofu", starch: "Basmati rice", veg: "Tomato and onion" },
  nutrition: { calories: 505, protein: 24, carbs: 58, fat: 21, fiber: 7 },
  ...
  steps: [
    ...
    "Fold in the roasted tofu, warm through 3 minutes, and finish with cilantro. Serve with rice and naan."
  ],
  tips: [
    "Roast the tofu separately and fold it in at the end. Simmering it in the sauce turns it spongy.",
    "The yogurt marinade tenderizes the surface and helps the spices actually stick."
  ],
